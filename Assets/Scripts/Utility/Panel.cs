...
using Yukgaejang.Utility; // PooledObject.cs의 기능을 쓰기 위한 네임스페이스
using UnityEngine;
using UnityEngine.UI;

public class Panel : PooledObject
{
    public enum HideLocation // UI가 사라질 방향
    {
        SAME_POSITION,
        LEFT_EDGE,
        RIGHT_EDGE,
